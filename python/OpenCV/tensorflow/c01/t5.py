...
def tensorboard():
    ...
    # 产生metadata文件
    if tf.gfile.Exists(DIR + 'projector/projector/metadata1.tsv'):
        tf.gfile.DeleteRecursively(DIR + 'projector/projector/metadata1.tsv')
    with open(DIR + 'projector/projector/metadata1.tsv', 'w') as f:
    ...
    embed.metadata_path = 'metadata1.tsv'
