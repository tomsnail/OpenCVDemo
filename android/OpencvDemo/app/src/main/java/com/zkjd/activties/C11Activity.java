...
public class C11Activity extends AppCompatActivity implements View.OnClickListener,ImagePickerAdapter.OnRecyclerViewItemClickListener {
    private String TAG = "C11Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn1_c11 = (Button)this.findViewById(R.id.btn1_c11);
        Button btn2_c11 = (Button)this.findViewById(R.id.btn2_c11);

        Button select_photo_btn_c11 = (Button)this.findViewById(R.id.select_photo_btn_c11);
        select_photo_btn_c11.setOnClickListener(this);
        btn1_c11.setOnClickListener(this);
        btn2_c11.setOnClickListener(this);

        option = getIntent().getIntExtra("TYPE", 0);
        viewList.add(R.id.dest1_imageView_c11);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.select_photo_btn_c11:
                index = 1;
       ...
       // Imgproc.cvtColor(src, src, Imgproc.COLOR_BGRA2GRAY);
        ...
        switch (index) {
            ...
            case R.id.btn2_c11:
                ...
                Imgproc.adaptiveThreshold(gray1, dst, 255,
        ...
        Mat result = new Mat();
        Imgproc.cvtColor(dst, result, Imgproc.COLOR_GRAY2BGR);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0: // 直接调起相机
                        ...
                        Intent intent = new Intent(C11Activity.this, ImageGridActivity.class);
                    ...
                    case 1:
                        //打开选择,本次允许选择的数量
                        ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                        Intent intent1 = new Intent(C11Activity.this, ImageGridActivity.class);
    ...
    private void displaySelectedImage() {
        ...
        imageView = (ImageView)this.findViewById(R.id.src_imageView_c11);
