...
public class C12Activity extends AppCompatActivity implements View.OnClickListener,ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn1_c12 = (Button)this.findViewById(R.id.btn1_c12);
        Button btn2_c12 = (Button)this.findViewById(R.id.btn2_c12);
        Button select_photo_btn_c12 = (Button)this.findViewById(R.id.select_photo_btn_c12);
        select_photo_btn_c12.setOnClickListener(this);
        btn1_c12.setOnClickListener(this);
        btn2_c12.setOnClickListener(this);
        option = getIntent().getIntExtra("TYPE", 0);
        viewList.add(R.id.dest1_imageView_c12);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.btn2_c12:
                a1(id);
                break;
            case R.id.select_photo_btn_c12:
                index = 1;
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0: // 直接调起相机
                        ...
                        Intent intent = new Intent(C12Activity.this, ImageGridActivity.class);
                    ...
                    case 1:
                        //打开选择,本次允许选择的数量
                        ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                        Intent intent1 = new Intent(C12Activity.this, ImageGridActivity.class);
    ...
    private void displaySelectedImage() {
        ...
        imageView = (ImageView)this.findViewById(R.id.src_imageView_c12);
