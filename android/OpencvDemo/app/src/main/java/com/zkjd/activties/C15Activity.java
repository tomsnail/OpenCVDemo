...
public class C15Activity extends AppCompatActivity implements View.OnClickListener,ImagePickerAdapter.OnRecyclerViewItemClickListener {
    private String TAG = "C15Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn1_c15 = (Button)this.findViewById(R.id.btn1_c15);

        Button select_photo_btn_c15 = (Button)this.findViewById(R.id.select_photo_btn_c15);
        Button select1_photo_btn_c15 = (Button)this.findViewById(R.id.select1_photo_btn_c15);
        select_photo_btn_c15.setOnClickListener(this);
        btn1_c15.setOnClickListener(this);
        select1_photo_btn_c15.setOnClickListener(this);
        option = getIntent().getIntExtra("TYPE", 0);
        viewList.add(R.id.dest1_imageView_c15);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.select_photo_btn_c15:
                index = 1;
                startUploadImage(1000,1000,1000,1000,false);
                break;

            case R.id.select1_photo_btn_c15:
                index = 2;
                startUploadImage(1000,1000,1000,1000,false);
                break;
            default:
    ...
    private void a1(int index){
       ...
       // Imgproc.cvtColor(src, src, Imgproc.COLOR_BGRA2GRAY);
        ...
        switch (index) {
            case R.id.btn1_c15:
                Mat tpl = Imgcodecs.imread(tUrl.getPath());;
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0: // 直接调起相机
                        ...
                        Intent intent = new Intent(C15Activity.this, ImageGridActivity.class);
                    ...
                    case 1:
                        //打开选择,本次允许选择的数量
                        ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                        Intent intent1 = new Intent(C15Activity.this, ImageGridActivity.class);
    ...
    private void displaySelectedImage() {
        ...
        if(index==1){
            imageView = (ImageView)this.findViewById(R.id.src_imageView_c15);

        }else{
            imageView = (ImageView)this.findViewById(R.id.src1_imageView_c15);
