...
public class C3Activity extends AppCompatActivity implements View.OnClickListener,ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn1_c3 = (Button)this.findViewById(R.id.btn1_c3);
        Button btn2_c3 = (Button)this.findViewById(R.id.btn2_c3);
        Button btn3_c3 = (Button)this.findViewById(R.id.btn3_c3);
        Button btn4_c3 = (Button)this.findViewById(R.id.btn4_c3);
        Button select_photo_btn_c2 = (Button)this.findViewById(R.id.select_photo_btn_c3);
        select_photo_btn_c2.setOnClickListener(this);
        btn1_c3.setOnClickListener(this);
        btn2_c3.setOnClickListener(this);
        btn3_c3.setOnClickListener(this);
        btn4_c3.setOnClickListener(this);
        option = getIntent().getIntExtra("TYPE", 0);
        viewList.add(R.id.dest1_imageView_c3);
    ...
    private void a1(){
        ...
        Bitmap bm = get(R.id.dest1_imageView_c3);
        Utils.bitmapToMat(bm,src);
        Mat dst1 = new Mat();
        Core.add(src, new Scalar(10,10,10), dst1);
    ...
    private void a3(){
        ...
        Utils.bitmapToMat(bm,src);
        Mat dst1 = new Mat();
        Core.multiply(src, new Scalar(1.1,1.1,1.1), dst1);
    ...
    private void a4(){
        ...
        Utils.bitmapToMat(bm,src);
        Mat dst1 = new Mat();
        Core.multiply(src,new Scalar(0.9,0.9,0.9), dst1);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0: // 直接调起相机
                        ...
                        Intent intent = new Intent(C3Activity.this, ImageGridActivity.class);
                    ...
                    case 1:
                        //打开选择,本次允许选择的数量
                        ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                        Intent intent1 = new Intent(C3Activity.this, ImageGridActivity.class);
    ...
    private void displaySelectedImage() {
        ...
        ImageView imageView = (ImageView)this.findViewById(R.id.src_imageView_c3);
        ...
        displayImage(R.id.dest1_imageView_c3,bm);
